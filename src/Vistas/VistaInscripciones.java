...
public class VistaInscripciones extends javax.swing.JInternalFrame {
    ...
    public VistaInscripciones() {
        ...
        try {
            ...
            ArrayList<Alumno> lista = (ArrayList)ad.obtenerAlumnos();
            for(Alumno it: lista){
    ...
    private void jbInscribirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbInscribirActionPerformed
        ...
        if (filaSeleccionada !=-1){
            ...
            cd.guardarCursada(c);
            borrarFilas();
            JOptionPane.showMessageDialog(null, "Se inscribió con excito");
        }else{
    ...
    private void jbAnularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAnularActionPerformed
        ...
        if(filaSeleccionada !=-1){
            Alumno a = (Alumno)jcAlumnos.getSelectedItem();
            int idMateria=(Integer)modelo.getValueAt(filaSeleccionada, 0);
            cd.borrarCursadaDeUnaMateriaDeunAlumno(a.getId_alumno(), idMateria);
            borrarFilas();
            JOptionPane.showMessageDialog(null, "Se anuló la inscripción");
        }
    ...
    public void cargaDatasInscriptas(){
        ...
        ArrayList<Materia> listaMaterias = cd.obtenerMateriasCursadas(alumno.getId_alumno());
        
        for(Materia m: listaMaterias){
            modelo.addRow(new Object[]{m.getId_materia(), m.getNombre_Materia(), m.getAño(), m.isEstado()});
        }
    ...
    public void cargaDatasNoInscriptas(){
        ...
        alumno = (Alumno)jcAlumnos.getSelectedItem();
        ArrayList<Materia> listaMaterias = cd.obtenerMateriasNOCursadas(alumno.getId_alumno());
